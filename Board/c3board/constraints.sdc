...
derive_pll_clocks 
create_generated_clock -name sd1clk_pin -source [get_pins {mypll|altpll_component|auto_generated|pll1|clk[0]}] [get_ports {sdram1_clk}]
create_generated_clock -name sd2clk_pin -source [get_pins {mypll2|altpll_component|auto_generated|pll1|clk[0]}] [get_ports {sdram2_clk}]
...
set_output_delay -clock sd1clk_pin -max 1.0 [get_ports sd1*]
set_output_delay -clock sd2clk_pin -max 1.0 [get_ports sd2*]
...
set_multicycle_path -from [get_clocks {sd2clk_pin}] -to [get_clocks {mypll|altpll_component|auto_generated|pll1|clk[1]}] -setup -end 2
